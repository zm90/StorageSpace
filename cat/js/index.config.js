...
var index_config_default = {
	ali: {
		token:
			"复制https://alist.nn.ci/zh/guide/drivers/aliyundrive.html 到浏览器打开，截图用阿里云盘扫码获取",
		token280:
			"去https://messense-aliyundrive-webdav-backendrefresh-token-ucs0wn.streamlit.app/地址获取，填入280位token，截屏扫码好像不行，用摄像头扫码识别",
	},
	quark: {
		cookie: "去https://pan.quark.cn/，获取你的夸克cookie填入",
	},
	yiso: {
		url: "https://yiso.fun",
	...
	live: {
		...
		url: [
			{ name: "摸摸", url: "http://api.v6x.wht.dgwht.top/text/863de13705ddfdc2/9aa228a41ac22ae6" },
		],
	},
	xiaoya: {
		url: "",
